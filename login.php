    ...
    <div class="flex items-center justify-center h-screen">
        <div
            ...
            <form class="space-y-6" method="post" action="login_api.php">
                ...
                <div>
                    <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">使用者
                        名稱</label>
                ...
                <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                    尚未註冊? <a href="register.php"
                        class="text-blue-700 hover:underline dark:text-blue-500">建立帳戶</a>
                </div>
            </form>
        </div>
    </div>
